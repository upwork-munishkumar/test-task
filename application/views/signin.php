        ...
        <div class="signup-form">
            ...
            <div class="form-group">
                ...
                <?php 
                    ...
                    if($this->session->flashdata('verify_msg')){
                        echo $this->session->flashdata('verify_msg');
                    }
                    echo form_input(['name'=>'emailid','class'=>'form-control','value'=>set_value('emailid'),'placeholder'=>'Enter your Email id']);
                    echo form_error('emailid',"<div style='color:red'>","</div>");
                ?>       	
            </div>
            <div class="form-group">
