...
<html lang="en">
    ...
    <body>
        <div class="signup-form">
            ...
            <?php echo form_open_multipart('add-product',['name'=>'add-product','autocomplete'=>'off']);?>
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col">
                        <?php echo form_input(['name'=>'title','class'=>'form-control','value'=>set_value('title'),'placeholder'=>'Product Name']);?>
                        <?php echo form_error('title',"<div style='color:red'>","</div>");?>
                    </div>
                    <div class="col">
                    	<?php echo form_input(['name'=>'quantity','class'=>'form-control','value'=>set_value('quantity'),'placeholder'=>'Enter product qunatity', 'type'=>'number']);?>
